...
function Calendar({ onDayClick }) {
    ...
    const handleDayDoubleClick = (day)=>{
        // Navigate to new schedule page with date prefilled
        const dateStr = day.date.toISOString().slice(0, 10);
        router.push(`/schedules/new?date=${encodeURIComponent(dateStr)}`);
    };
    if (loading) {
...
_s(Calendar, "ge8mdjJs8Td2f+Bxo6UpY8qd+ws=", false, function() {
    return [
...
//# sourceMappingURL=_5fb5f6e6._.js.map