...
async function performTesseractOCR(base64Data) {
    try {
        ...
        const filePath = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(tmpDir, fileName);
        ...
        const tesseract = await __turbopack_context__.A("[project]/calenderapp/node_modules/node-tesseract-ocr/src/index.js [app-route] (ecmascript, async loader)");
        const config = {
            lang: "jpn+eng",
            oem: 1,
            psm: 3
...
async function POST(request) {
    try {
        ...
        if (!hasAnthropicKey) {
            console.warn("Anthropic API key not configured — will use local Tesseract fallback");
        }
                ...
                if (nm) {
                    for (const line of lines){
                        if (normalize(line).includes(nm)) {
                            ...
                            const endTime = timeMatch && timeMatch.length > 1 ? timeMatch[1] : null;
                            schedules.push({
                                date: date || undefined,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c5c04f7b._.js.map